<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoMateria.aspx.cs" Inherits="Sistema_Bitacora_.GrupoMateria" %>
     ...
     <label for="TextBox1">Inserte el turno:</label>   
        ...
        <div class="form-floating text-center">
         ...
         <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-select mb-2"></asp:DropDownList>
           ...
           <asp:Button ID="Button1" runat="server" Text="Insertar datos" CssClass="btn btn-dark btn-lg mt-3" OnClick="Button1_Click" />
       ...
       <a href="Index.aspx" class="btn btn-success btn-lg mt-4">Ir a Inicio</a>
          ...
          <asp:GridView ID="GridView1" runat="server" CssClass="table table-dark table-striped">
            ...
            <asp:TemplateField HeaderText="Edición" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-warning m-2" OnClick="EditarGroupCuatrimestre" ID='LinkButton2' runat="server" Text="Editar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>

                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Eliminación" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-danger m-2" OnClick="EliminarGroupCuatrimestre" ID='LinkButton3' runat="server" Text="Eliminar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>
