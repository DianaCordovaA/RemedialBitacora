<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cuatrimestre.aspx.cs" Inherits="Sistema_Bitacora_.Cuatrimestre" %>
    ...
    <asp:Button ID="Button1" runat="server" Text="Insertar nuevo cuatrimestre" CssClass="btn btn-dark btn-lg mt-3" OnClick="Button1_Click" />
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-dark table-striped">
            ...
            <asp:TemplateField HeaderText="Edición" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-warning m-2" OnClick="EditarCuatri" ID='LinkButton2' runat="server" Text="Editar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>

                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Eliminación" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-danger m-2" OnClick="EliminarCuatri" ID='LinkButton3' runat="server" Text="Eliminar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>
