<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Materia.aspx.cs" Inherits="Sistema_Bitacora_.WebForm1" %>
...
<body>
  ...
  <label for="TextBox1">Inserte el nombre de la materia:</label>
</div>

               <div class="form-floating text-center">
       <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control mb-3" MaxLength="3" ></asp:TextBox>
  <label for="TextBox2">Inserte horas por semana:</label>
</div>
   ...
   <asp:Button ID="Button1" runat="server" Text="Insertar nueva materia" CssClass="btn btn-dark btn-lg mt-3" OnClick="Button1_Click" />
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-dark table-striped">
            ...
            <asp:TemplateField HeaderText="Edición" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-warning m-2" OnClick="EditarMateria" ID='LinkButton2' runat="server" Text="Editar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>

                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Eliminación" SortExpression="[Id Especifico]">
                <ItemTemplate>
                    <asp:Button CssClass="btn btn-outline-danger m-2" OnClick="EliminarMateria" ID='LinkButton3' runat="server" Text="Eliminar registro" CommandArgument='<%# Bind("[Codigo]")%>'></asp:Button>
